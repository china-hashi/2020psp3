...
l.85: 表が埋まるまで以下の処理を繰り返す

l.86,87: 入らない場合は上の値を引き継ぐ

l.88: ベースにした値のインデックスを記憶

l.90: 入る場合は以下の処理を繰り返す

l.93,94: もし入れ替えた値のほうが大きければ入れ替えた値にする

l.95: ベースにした値のインデックスを記憶

l.96,97: そうでなければそのままの値を引き継ぐ

l.98: ベースにした値のインデックスを記憶

l.106: iが１になるまで以下の処理を繰り返す

l.108,109: pre_jとcur_jの値が等しくなければその時のメニューを出力
